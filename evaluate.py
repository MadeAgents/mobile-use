...
parser = argparse.ArgumentParser(description="Evaluate the performance of the agent.")
parser.add_argument('--result_path', type=str, required=True, help='Path to the output Excel file containing the evaluation results.')
args = parser.parse_args()

# Load the evaluation results from the specified Excel file
